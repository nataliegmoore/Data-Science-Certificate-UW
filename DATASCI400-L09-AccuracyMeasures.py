...
train and test the Census data and predict the education level of adults with 
...
#de-coding the Education column
#Census.loc[Census.loc[:,"Education"] == " Preschool", "Education"] = 0
#Census.loc[Census.loc[:,"Education"] == " 1st-4th", "Education"] = 0
##renaming Race column to be Race_decoded
#Census.rename(columns={'Education': 'Education_decoded'}, inplace=True)
